$(document).ready(function() {
    ...
    //Create variables that represent tasks by hour and also today's date and time
    let timeEl = $('<p>');
    let dayEl = $('<p>');
    let box1 = $('#div1');
    let box2 = $('#div2');
    ...
    //Sets each hours task based on what is stored in local storage
    ...
    //Create variables that store the save button objects for each hour
    let button9 = $('#btn9');
    let button10 = $('#btn10');
    let button11 = $('#btn11');
    let button12 = $('#btn12');
    ...
    //Clears local storage and clears the calendar  
    function clear() {
        localStorage.clear();
    ...
    //Shows current date and time in the top of the calendar and append this at the end of the jumbotron
    function tick() {
